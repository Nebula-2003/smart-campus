...
function SidebarDemo({ children }) {
    const navItems = [
        { href: "/dashboard", icon: Home, label: "My profile", active: true },
        { href: "/dashboard/daily-updates", icon: Calendar, label: "Daily Updates" },
        { href: "#", icon: FileText, label: "Assignment Updates" },
                ...
                <header className="sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="flex items-center justify-between px-4 py-3">
                        ...
                        <div className="relative w-full max-w-md mx-4">
                            <Input type="search" placeholder="Search..." className="pl-10 bg-gray-100 dark:bg-gray-700 border-0" />
                            <svg
